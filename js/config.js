var size = 9;
var proxy = ['', 'https://myfetch.ciu.workers.dev/'];
var fetchArrCat = 'https://'+target+'/wp-json/wp/v2/categories?per_page=50&page=1';
var fetchCat = 'https://'+target+'/wp-json/wp/v2/posts?categories='+cat+'&per_page='+size+'&page='+page;
var fetchUrl = 'https://'+target+'/wp-json/wp/v2/posts?per_page='+size+'&page='+page;
...
var nextPage = '<a href="?x='+x+'&s='+s+'&'+ifCat+ifId+'p='+p+'&page='+(page*1+1)+ifT+'">NEXT &raquo;</a>';
